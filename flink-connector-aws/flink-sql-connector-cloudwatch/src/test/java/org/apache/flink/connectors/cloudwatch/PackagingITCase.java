...
package org.apache.flink.connectors.cloudwatch;
...
class PackagingITCase {
    ...
    void testPackaging() throws Exception {
        final Path jar =
                ResourceTestUtils.getResource(".*/flink-sql-connector-cloudwatch[^/]*\\.jar");

        PackagingTestUtils.assertJarContainsOnlyFilesMatching(
                jar,
                Arrays.asList("org/apache/flink/", "mime.types", "META-INF/", "VersionInfo.java"));
