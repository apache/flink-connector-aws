...
import org.apache.flink.connector.dynamodb.source.enumerator.tracker.ShardGraphTracker;
...
public class DynamoDbStreamsSourceEnumerator
        ...
        for (int i = 0;
            ...
            ListShardsResult shardsToResolveInconsistencies =
                    streamProxy.listShards(
                            streamArn, shardGraphTracker.getEarliestClosedLeafNode());
    ...
    private ListShardsResult initialDiscoverSplits() {
