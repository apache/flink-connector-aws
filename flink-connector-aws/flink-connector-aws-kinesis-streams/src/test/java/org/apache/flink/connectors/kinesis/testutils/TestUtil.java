...
public class TestUtil {
    ...
    public static void sendMessage(String topic, KinesisClient kinesisClient, String... messages) {
        sendMessage(
                topic,
                kinesisClient,
    ...
    public static void sendMessage(String topic, KinesisClient kinesisClient, byte[]... messages) {
