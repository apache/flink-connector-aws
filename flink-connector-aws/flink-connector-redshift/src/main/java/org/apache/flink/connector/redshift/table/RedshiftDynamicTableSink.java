...
public class RedshiftDynamicTableSink implements DynamicTableSink {
    ...
    private final DataType[] fielDataTypes;
    ...
    public RedshiftDynamicTableSink(
            ...
            String[] primaryKeys,
            String[] fieldNames,
            DataType[] fielDataTypes) {

        this.primaryKeys = primaryKeys;
        this.fieldNames = fieldNames;
        this.fielDataTypes = fielDataTypes;
    ...
    public DynamicTableSink copy() {
        return new RedshiftDynamicTableSink(
                this.options, this.primaryKeys, this.fieldNames, this.fielDataTypes);
    }
