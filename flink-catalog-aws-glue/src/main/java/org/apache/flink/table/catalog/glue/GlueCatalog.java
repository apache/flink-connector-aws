...
public class GlueCatalog extends AbstractCatalog {
    ...
    /**
     * instance of glueUtils to facilitate glue related actions.
     */
    ...
    public void createPartition(
        ...
        Table glueTable = glueUtils.getGlueTable(tablePath);
        glueUtils.ensurePartitionedTable(getName(), tablePath, glueTable);

        try {
            glueUtils.createGluePartition(glueTable, partitionSpec, partition, getName());
    ...
    public void dropPartition(
        ...
        if (partition != null) {
            glueUtils.dropGluePartition(tablePath, partitionSpec);
        } else if (!ignoreIfNotExists) {
    ...
    public void alterPartition(
        ...
        if (existingPartition != null) {
            glueUtils.alterGluePartition(tablePath, existingPartition, newPartition);
