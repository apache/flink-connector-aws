...
import static org.apache.flink.table.catalog.glue.GlueCatalogTestUtils.EXPANDED_TEXT;
import static org.apache.flink.table.catalog.glue.GlueCatalogTestUtils.FUNCTION_1;
import static org.apache.flink.table.catalog.glue.GlueCatalogTestUtils.ORIGINAL_TEXT;
...
class GlueCatalogTest {
    ...
    void testCreateDatabase() throws DatabaseNotExistException {
        ...
        Assertions.assertDoesNotThrow(
                () -> glueCatalog.createDatabase(DATABASE_1, catalogDatabase, true));
        Assertions.assertDoesNotThrow(
    ...
    public void testListTables() throws DatabaseNotExistException {
        ...
        Assertions.assertEquals(
                Lists.newArrayList(TABLE_1, TABLE_2, TABLE_3, TABLE_4, TABLE_5, VIEW_1),
                glueCatalog.listTables(DATABASE_1));
    }
    ...
    public void testAlterTable() throws TableNotExistException {
        ...
        CatalogBaseTable table1 =
                CatalogTable.of(
                        modifiedSchema, "Changed Comment", new ArrayList<>(), modifiedOptions);
    ...
    private void createView(ObjectPath tablePath) {
        CatalogView catalogView =
                CatalogView.of(
                        ...
                        EXPANDED_TEXT,
                        getDummyTableParams());
        Assertions.assertDoesNotThrow(() -> glueCatalog.createTable(tablePath, catalogView, true));
    }
