...
public class GlueCatalogTestUtils {
    ...
    public static CatalogBaseTable getDummyCatalogTable() {
        return CatalogTable.of(
                Schema.newBuilder()
                        .column(COLUMN_1, DataTypes.STRING())
                        .column(COLUMN_2, DataTypes.INT())
                        .build(),
                COMMENT,
                new ArrayList<>(),
                getDummyTableParams());
    ...
    public static CatalogBaseTable getDummyCatalogTableWithPartition() {
        ...
        partitionKeys.add(COLUMN_1);
        partitionKeys.add(COLUMN_2);
        final Schema schema =
                Schema.newBuilder()
                        .column(COLUMN_1, DataTypes.STRING())
                        .column(COLUMN_2, DataTypes.INT())
                        .build();
        return CatalogTable.of(schema, COMMENT, partitionKeys, getDummyTableParams());
    }
