...
public class GlueUtils {
    ...
    public static Column getGlueColumn(final Schema.UnresolvedColumn column)
        ...
        if (column instanceof Schema.UnresolvedPhysicalColumn) {
            ...
            // DataType datatype = unresolvedPhysicalColumn.getDataType().bridgedTo();
        ...
        //        if (dataType != null) {
        //            String glueDataType = dataType.toString();
        //
        //        } else {
        //
        //        }
        ...
        return Column.builder()
                ...
                .type("string")
                .name(columnName)
                .parameters(getGlueColumnParams(column))
                .build();
    }

    public static Map<String, String> getGlueColumnParams(Schema.UnresolvedColumn column) {
        // todo here 1.1114
        return new HashMap<>();
    }
     ...
     */
    public static List<Column> getGlueColumnsFromCatalogTable(
        ...
        // catalogBaseTable.getUnresolvedSchema().getColumns().get(0).getClass();
